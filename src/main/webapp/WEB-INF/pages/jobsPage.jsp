...
<body>
    ...
    <div class="main">  
        ...
        <div id="reactJobsMap" style="display: none"></div>
        <div id="canvasStart"></div>
        <canvas id="treeCanvas" data-paper-resize="true" class="canvas"></canvas>
        <canvas id="mapCanvas" data-paper-resize="true" style="display: none" class="canvas"></canvas>
        <script src="${pageContext.request.contextPath}/resources/js/getJobsMap.js" type = "text/babel"></script>
        <script src="${pageContext.request.contextPath}/resources/js/getJobStatusTree.js" type = "text/babel"></script>
